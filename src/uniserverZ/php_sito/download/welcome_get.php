...
<title>Risposta Metodo GET</title>
...
<main><article><div class=title><h1 class=title>Rispota alla pagina di invio della FORM con il metodo GET </h1><div class=meta>Posted on Nov 26, 2021</div></div>
<p>Il <b>metodo GET</b> invia i dati in chiaro (vedere la barra di indirizzo del browser).

<h1>Welcome </h1>
<?php 
// la variabile d'ambiente o superglobal è un array ASSOCIATIVI, 
// gli indici in questo caso sono: "nome" ed "email" e i valori 
// associati sono quelli inseriti dall'utente 
echo "Benvenuto <b>".$_GET["nome"]."</b><br>"; 
echo "Il tuo indirizzo di posta elettronica è: <b>".$_GET["email"]."</b><br>"; 
?>
