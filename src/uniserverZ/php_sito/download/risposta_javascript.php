...
<title>Risposta JAVASCRIPT</title>
...
<main><article><div class=title><h1 class=title>Rispota alla pagina di invio della FORM con il controllo JAVASCRIPT</h1><div class=meta>Posted on dic 11, 2021</div></div>
<p><b></b> </p>
...
echo "Benvenuto <b>".$_POST["nome"]."</b><br>"; 
echo "Il tuo indirizzo di posta elettronica è: <b>".$_POST["email"]."</b><br>"; 
?>
