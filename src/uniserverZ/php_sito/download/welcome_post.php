...
<title>Risposta Metodo POST</title>
...
<main><article><div class=title><h1 class=title>Rispota alla pagina di invio della FORM</h1><div class=meta>Posted on Nov 26, 2021</div></div>

<h1>Welcome </h1>
<?php 

echo "Benvenuto <b>".$_POST["name"]."</b><br>"; 
